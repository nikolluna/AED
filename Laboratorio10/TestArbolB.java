...
public class TestArbolB {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("");
        System.out.println("ELIMINAR 90");
        arbolB.eliminar(90);
        System.out.println("ESTADO ARBOL B");
        arbolB.showBTree();
        ...
        List<Integer> lista = arbolB.obtenerCaminoRecorrido(10);
        
        for (Integer e : lista) {
        	System.out.println(e);
        }
        
        System.out.println("MAXIMO VALOR: "+arbolB.ObtenerValorMaximo());
        System.out.println("MINIMO VALOR: ");
        arbolB.ObtenerNodoMinimoRaiz();
